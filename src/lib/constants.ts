...
export const PRICING = [
  {
    ...
    features: [
      ...
      "4x Pertemuan Mengaji",
      "Jadwal Menyesuaikan Kamu",
      "Free Modul & Laporan Perkembangan",
      "Guru Ngaji Bersertifikat",
      "Pemantauan Progress Berkelanjutan",
      "Durasi Maksimal 50 Menit / sesi",
      "Akses Qurantiva Circle (1 Bulan)",
    ],
    highlight: false,
  ...
  },
  {
    ...
    features: [
      "Sesi privat eksklusif 1-on-1",
      "8x Pertemuan Mengaji",
      "Jadwal Menyesuaikan Kamu",
      "Free Modul & Laporan Perkembangan",
      "Guru Ngaji Bersertifikat",
      "Pemantauan Progress Berkelanjutan",
      "Durasi Maksimal 50 Menit / sesi",
      "Akses Qurantiva Circle (2 Bulan)",
    ],
    highlight: true,
  ...
  },
  {
    ...
    features: [
      "Sesi privat eksklusif 1-on-1",
      "12x Pertemuan Mengaji",
      "Jadwal Menyesuaikan Kamu",
      "Free Modul & Laporan Perkembangan",
      "Guru Ngaji Bersertifikat",
      "Pemantauan Progress Berkelanjutan",
      "Durasi Maksimal 50 Menit / sesi",
      "Akses Qurantiva Circle (3 Bulan)",
    ],
    highlight: false,
    ctaText: "Pilih Paket III",
  },
  {
    name: "Paket Berkelompok",
    price: "Rp. 300.000",
    period: "",
    features: [
      "10x Pertemuan Interaktif",
      "Kelompok Kecil (Maksimal 5 Orang)",
      "Suasana Belajar Suportif & Menyenangkan",
      "Modul & Materi Pembelajaran Gratis",
      "Laporan Perkembangan Hasil Belajar",
      "Durasi Maksimal 90 Menit / sesi",
      "Pengajar Bersertifikat",
      "Akses Qurantiva Circle (selama kelas berlangsung)",
    ],
    highlight: false,
  ...
  },
  {
    ...
    features: [
      "Sesi Privat 1-on-1",
      "1x Pertemuan",
      "Kelas Placement Test",
      "Konsultasi Target Belajar dengan Mentor",
      "Laporan Evaluasi",
      "Feedback langsung dari tutor",
      "Rekomendasi belajar sesuai kompetensi",
    ],
    highlight: false,
...
export const COMPARISON = {
  features: [
    "Sesi Privat 1-on-1",
    "Jadwal Fleksibel (Bebas Atur Waktu)",
    "Pengajar Bersertifikat & Berpengalaman",
    "Hasil Placement Test",
    "Free Modul & Materi Pembelajaran",
    "Laporan Progress Belajar",
    "Bisa Reschedule / Atur Ulang Sesi",
    "Garansi Bebas Ganti Pengajar",
    "Konsultasi Pendampingan",
    "Rekap Bacaan & Evaluasi Mentor",
    "Tracker Konsisten Bulanan",
    "Akses Qurantiva Circle",
  ],
  programs: [
    {
      name: "Private",
      values: [
        ...
        { check: true },
        { check: true },
        { check: true, note: "Setiap Sesi" },
        { check: true, note: "Min H-1" },
        { check: true },
        { check: true },
        { check: true },
        { check: true },
        { check: true, note: "1–3 Bulan" },
      ],
    },
    {
      name: "Berkelompok",
      values: [
        ...
        { check: true },
        { check: true },
        { check: true, note: "Berkala" },
        { check: false },
        { check: false },
        { check: false },
        { check: false },
        { check: true },
        { check: true, note: "1 Program" },
      ],
    },
    {
      name: "Starter",
...
export const CERTIFICATES = [
  {
    ...
    desc: "Seluruh pengajar memegang lisensi resmi dari Ummi Foundation untuk menjamin standar dan kualitas bacaan.",
  },
  {
    title: "Bersanad Al-Qur'an & Hafidz/ah",
    desc: "Dipandu oleh Hafidz/Hafidzah 30 Juz serta guru yang memiliki jalur keilmuan sanad Al-Qur'an yang bersambung dan teruji.",
  },
  {
    title: "Alumni Pesantren",
    desc: "Pengajar merupakan lulusan dari pondok pesantren pilihan dengan kedalaman ilmu tajwid, makhraj, dan pemahaman Al-Qur'an yang kuat.",
  },
  {
    title: "Akademisi Al-Qur'an",
    desc: "Memiliki latar belakang pendidikan formal di bidang studi Islam, memastikan materi disampaikan secara terstruktur dan mudah dipahami.",
  },
  {
    title: "Berpengalaman & Terlatih Online",
    desc: "Memiliki jam terbang tinggi dalam mengajar serta dilatih khusus untuk menyampaikan materi pembelajaran Al-Qur'an secara interaktif via daring.",
  },
  {
    title: "Sabar & Komunikatif",
    desc: "Dipilih tak hanya dari keilmuan, tapi juga karakter yang ramah, empati, dan sabar dalam membimbing murid privat dari nol tanpa rasa canggung.",
  },
];
...
export const PAKET_OPTIONS = [
  "Paket Privat I (4 Sesi) – Rp300.000",
  "Paket Privat II (8 Sesi) – Rp570.000",
  "Paket Privat III (12 Sesi) – Rp800.000",
  "Kelas Berkelompok (10 Sesi) – Rp300.000",
  "Kelas Starter (1 Sesi Trial) – Rp25.000",
];
